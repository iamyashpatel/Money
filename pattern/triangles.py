...
if __name__ == "__main__":
    df = pd.read_csv(r"data\eurusd-4h.csv")
    ohlc = find_triangle_pattern(df, progress=True, triangle_type="ascending")
    display_chart_pattern(ohlc, pattern="triangle", lookback=100)
